...
function Cart({ className, close }) {
  ...
  return (
    <div
      className={`  hidden  absolute top-[40px] lg:left-[-170px] z-50 left-[-170px]  ${className}`}
    >
      <div
        className="relative  lg:w-screen lg:max-w-sm border border-gray-600 bg-gray-100 w-[350px] px-4 py-8 sm:px-6 lg:px-8"
        aria-modal="true"
        role="dialog"
        tabIndex="-1"
      >
        ...
        <div className="mt-4 space-y-6">
          <ul className="space-y-4 max-h-[400px] pr-4 overflow-y-scroll">
            {cartLoop}
          </ul>
